    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-3.5 rounded-xl font-bold shadow-lg shadow-blue-500/25 transition-all hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-500/40 hover:-translate-y-0.5 active:scale-95"
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            {currentBooking ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center w-full px-4">
                <div className="mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-slate-50 border border-slate-100 shadow-sm animate-pulse">
                  <MapPin className="h-10 w-10 text-slate-300" />
                </div>
                <h4 className="text-xl font-bold text-slate-900 mb-2">No active bookings</h4>
                {/* <p className="text-slate-500 mb-8 max-w-sm mx-auto">Create a new booking request to see your active ride details here.</p> */}
                <button
                  className="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-blue-500/25 transition-all hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-500/40 hover:-translate-y-0.5 active:scale-95"
                  onClick={() => router.push('/user/ambulance')}
                >
                  Book an ambulance
                </button>
