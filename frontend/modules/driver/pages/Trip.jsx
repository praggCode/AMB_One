                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="p-8">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <span className="px-4 py-2 bg-emerald-500 text-white text-sm font-bold rounded-full uppercase tracking-wide flex items-center gap-2">
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-6 relative pl-4 border-l-2 border-dashed border-gray-200 ml-2">
                                            ...
                                            <div className="relative">
                                                <div className="absolute -left-[25px] top-1.5 w-4 h-4 rounded-full bg-red-500 ring-4 ring-white" />
