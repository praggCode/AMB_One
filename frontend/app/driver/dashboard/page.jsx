        ...
        <div className="min-h-screen bg-gray-50/50 font-sans">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="space-y-4">
                    {pendingBookings.length === 0 && !driverTrip && (
                        <div className="text-center py-12 bg-white rounded-2xl border border-gray-200 border-dashed">
                            <div className="mx-auto h-16 w-16 bg-gray-50 rounded-full flex items-center justify-center mb-4">
                                <LayoutDashboard className="h-8 w-8 text-gray-400" />
                            </div>
                            <h3 className="text-lg font-medium text-gray-900">No Pending Requests</h3>
                            <p className="text-gray-500 mt-1">New booking requests will appear here</p>
                        </div>
                    )}
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow border-l-4 border-l-[#2563EB]">
                            <div className="p-6">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900">Trip #{driverTrip.bookingId || driverTrip._id}</h3>
