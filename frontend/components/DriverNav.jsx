...
const defaultTabs = [
    ...
    { label: 'Rides', href: '/driver/rides' },
    { label: 'Earnings', href: '/driver/earnings' },
];

export default function DriverNav({ active = '', tabs = defaultTabs }) {
        ...
        <header className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
                ...
                >
                    ...
                    <span className="text-xl font-bold text-gray-900 tracking-tight">MediRide Driver</span>
                </div>
